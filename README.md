...
[Fullstack Invaders] (fullstack-invaders.herokuapp.com/)
...
### D - Turn Right
### Space Bar - Fire
### Look for Health and Power Ups throughout the game

## Start

Sync and seed your database by running `npm run seed js`. Running `npm run start:dev` will make great things happen!
...
# Phaser - HTML5 Game Framework for Reference
