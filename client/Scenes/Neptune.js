...
export default class Neptune extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("triton", "assets/triton.png");
  ...
  create() {
    ...
    this.sun = this.add.sprite(-1750, 2000, "sun").setDisplaySize(1000, 1000).setDepth(1);
    this.triton = this.add.sprite(2500, -500, "triton").setDisplaySize(350, 350).setDepth(1);
    this.bg = this.add
    ...
    this.mothership1 = this.motherships.get(-500, -1000);
    this.mothership2 = this.motherships.get(-750, 500);
